class ManaPotion extends Item{
    ...
    public static ManaPotion LowlyFlaskofTears(){
        return new ManaPotion("Lowly Flask of Tears", "Restores 20 MP.", 50);
    }

    public static ManaPotion GreatFlaskofDemiGodTears(){
        return new ManaPotion("Great Flask of DemiGod Tears", "Restores 70 MP.", 100);
    }

    public static ManaPotion AbsoluteFlaskofGodTears(){
